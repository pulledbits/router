...
class RouterTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddPath_When_ExistingRoute_Expect_ResponseReturned()
    {
        ...
        file_put_contents($file, '<?php return function(Psr\Http\Message\ServerRequestInterface $request) : pulledbits\Router\RouteEndPoint
        {
            return new class implements pulledbits\Router\RouteEndPoint
            {
                ...
                {
                    return $psrResponse->withBody(new class implements Psr\Http\Message\StreamInterface {
    ...
    public function testRoute_When_ExistingRouteAndAttriubtes_Expect_ResponseWithAttributesReturned()
    {
        ...
        $router = new Router(["/hello/(?<where>\w+)" => function(ServerRequestInterface $request) : RouteEndPoint
        {
            return new class($request->getAttribute('where')) implements RouteEndPoint
            {
                ...
                public function respond(ResponseInterface $psrResponse): ResponseInterface
                {
                    return $psrResponse->withBody(new class($this->where) implements StreamInterface {
